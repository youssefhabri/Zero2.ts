...
export default class extends MusicCommand {
  ...
  resolvePermissions(msg, voiceChannel) {
    ...
    if (!permissions.has(Permissions.FLAGS.CONNECT)) throw 'I do not have enough permissions to connect to your voice channel. I am missing the CONNECT permission.';
    if (!permissions.has(Permissions.FLAGS.SPEAK)) throw 'I can connect... but not speak. Please turn on this permission so I can emit music.';
  }
